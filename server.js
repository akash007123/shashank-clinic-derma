...
app.post("/send-mail", async (req, res) => {
  ...
  const adminMailOptions = {
    from: EMAIL_USER,
    to: ADMIN_EMAIL,
    subject: "📅 New Appointment Booking - Shashank Bhargawa Clinic",
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
        ...
        <p><strong>Sosapient Team</strong></p>
        <hr style="border: none; border-top: 1px solid #ddd;" />
        <p style="font-size: 12px; color: #777;">For inquiries, contact us at <a href="mailto:akashraikwar763@gmail.com">akashraikwar763@gmail.com</a> <a href="tel:+919685533878">9685533878</a></p>
      </div>
    `,
  };
